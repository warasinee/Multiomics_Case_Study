...
library(igraph)
my.network.conserved <- igraph::read_graph("/Users/wmujchariyak/Desktop/myNetwork_conserved_Kleb_cor096.gml",format=c("gml"))
...
# Verify the number of nodes (32) and edges (160):
igraph::vcount(my.network.conserved)
igraph::ecount(my.network.conserved)

# Common iGraph functions
# Calculate degree for all nodes
degAll <- igraph::degree(my.network.conserved, v = igraph::V(my.network.conserved), mode = "all")
...
# Calculate degree for all nodes
degree_values <- igraph::degree(my.network.conserved, v = igraph::V(my.network.conserved), mode = "all")
...
saveSession("/Users/wmujchariyak/Desktop/my.network.Kelb.070425.cys") 

# PNG/PDF/SVG format
?exportImage
full.path=paste("/Users/wmujchariyak/Desktop/","my.network.Kelb.070425",sep="/")
