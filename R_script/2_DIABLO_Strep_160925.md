...
\*\* With the pairwise PLS comparison results (cor &gt; 0.9), all omics
datasets are highly connected. Therefore, we can adjust “design matrix”
to 0.5 to balance power between identifying correlation features across
omics and achieving classification accuracy.  
\*\* 1 = maximize relationship enforced (between blocks), 0 = no
relationship enforced (discrimination focus) \*\* diagonal is set to
zero so there is no self linked (in the same block).
    ...
    ## Transcript           0.0     0.5           0.5
    ## Protein              0.5     0.0           0.5
    ## Metabolite_GC        0.5     0.5           0.0
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-6-1.png)

    plotLoadings(basic.diablo.model)

![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-6-2.png)
...
## Final DIABLO model
    ...
    ## Transcript           0.0     0.5           0.5 1
    ## Protein              0.5     0.0           0.5 1
    ## Metabolite_GC        0.5     0.5           0.0 1
    ## Y                    1.0     1.0           1.0 0
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-9-1.png)

    auc.diablo.prot.com <- auroc(final.diablo.model, roc.block = "Protein", roc.comp = 1,
                            print = FALSE)

![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-9-2.png)

    auc.diablo.met.GC.com <- auroc(final.diablo.model, roc.block = "Metabolite_GC", roc.comp = ,
                            print = FALSE)

![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-9-3.png)
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-10-1.png)
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-11-1.png)

    # Plot Loadings
    plotLoadings(final.diablo.model, comp = 1, contrib = 'max', method = 'median', size.name = 0.65)

![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-12-1.png)
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-13-1.png)
...
![](2_DIABLO_Strep_160925_files/figure-markdown_strict/unnamed-chunk-14-1.png)
