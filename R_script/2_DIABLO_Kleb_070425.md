...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-6-1.png)

    plotLoadings(basic.diablo.model)

![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-6-2.png)
...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-9-1.png)

    auc.diablo.prot.com <- auroc(final.diablo.model, roc.block = "Protein", roc.comp = 1,
                            print = FALSE)

![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-9-2.png)

    auc.diablo.met.GC.com <- auroc(final.diablo.model, roc.block = "Metabolite_GC", roc.comp = ,
                            print = FALSE)

![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-9-3.png)
...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-10-1.png)
...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-11-1.png)

    # Plot Loadings
    plotLoadings(final.diablo.model, comp = 1, contrib = 'max', method = 'median', size.name = 0.65)

![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-12-1.png)
...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-13-1.png)
...
![](2_DIABLO_Kleb.md_files/figure-markdown_strict/unnamed-chunk-14-1.png)
