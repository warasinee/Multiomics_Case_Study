...
library(igraph)
my.network.conserved <- igraph::read_graph("/Users/wmujchariyak/Desktop/myNetwork_conserved_Strep.gml",format=c("gml"))
...
# Verify the number of nodes (24) and edges (76):
