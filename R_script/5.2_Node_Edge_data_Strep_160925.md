...
## Collect node and edge data - strain SP444
    ...
    ## # A tibble: 5 × 4
    ##   from                            to               nb_omics_with_edge similarity
    ##   <chr>                           <chr>                         <int>      <dbl>
    ## 1 Vancomycin resistance           Alanine, aspart…                  1      0.2  
    ## 2 Fructose and mannose metabolism Amino sugar and…                  1      0.297
    ## 3 Galactose metabolism            Amino sugar and…                  1      0.261
    ## 4 Glycolysis / Gluconeogenesis    Amino sugar and…                  1      0.2  
    ## 5 Phosphotransferase system (PTS) Amino sugar and…                  1      0.343

    head(all_node_SP444_GSEA_KEGG, 5)

    ## # A tibble: 5 × 3
    ##   name                                        nb_omics_with_node gene_set_size
    ##   <chr>                                                    <int>         <dbl>
    ## 1 Alanine, aspartate and glutamate metabolism                  1             6
    ## 2 Amino sugar and nucleotide sugar metabolism                  1            21
    ## 3 Aminoacyl-tRNA biosynthesis                                  1            15
    ## 4 Ascorbate and aldarate metabolism                            1            15
    ## 5 Biosynthesis of amino acids                                  1            37
