...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_1.png)
...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_2.png)

    plotLoadings(basic.diablo.model)

![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_3.png)
...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_4.png)

    auc.diablo.prot.com <- auroc(final.diablo.model, roc.block = "Protein", roc.comp = 1,
                            print = FALSE)

![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_5.png)

    auc.diablo.met.GC.com <- auroc(final.diablo.model, roc.block = "Metabolite_GC", roc.comp = ,
                            print = FALSE)

![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_6.png)
...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_7.png)
...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_8.png)

    # Plot Loadings
    plotLoadings(final.diablo.model, comp = 1, contrib = 'max', method = 'median', size.name = 0.65)

![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_9.png)
...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_10.png)
...
![](https://github.com/warasinee/Multiomics_Case_Study/blob/main/Image/Report_plots/2.2_DIABLO_11.png)
