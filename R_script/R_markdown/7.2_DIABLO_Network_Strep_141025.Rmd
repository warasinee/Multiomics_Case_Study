...
# Save 
```{r}
#saveRDS(GSEA.output.trans, file = "/Users/wmujchariyak/Desktop/Strep.DIABLO.05.GSEA.output.trans.rds")
```
...
# save 
```{r}
#write.table(all_edge_DIABLO_trans_GSEA_KEGG, "/Users/wmujchariyak/Desktop/Strep_all_edge_DIABLO_05_trans_GSEA_KEGG.tsv", sep = "\t", row.names = F)
#write.table(all_node_DIABLO_trans_GSEA_KEGG, "/Users/wmujchariyak/Desktop/Strep_all_node_DIABLO_05_trans_GSEA_KEGG.tsv", sep = "\t", row.names = F)
```
